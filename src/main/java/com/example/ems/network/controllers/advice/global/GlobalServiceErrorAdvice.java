...
public class GlobalServiceErrorAdvice {
	...
	public ResponseEntity<Res<Object>> handleResourceNotFoundException(HttpServletRequest req, Exception e) {
		log.error("message: {}", e.getMessage());
		return response.formattedError(
				req,
	...
	public ResponseEntity<Res<Object>> handleUserIDNotfound(HttpServletRequest req, UserIDNotFoundException e) {
		log.info("message: {}", e.getMessage());
		return response.formattedError(
				req,
